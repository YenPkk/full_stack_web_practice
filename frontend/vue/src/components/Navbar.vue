<script setup>
import logo from '@/assets/img/logo.png'; // @ is a alias for src folder (src means source)
import { RouterLink, useRoute } from "vue-router"; // useRoute 可以獲取現在頁面的url
          ...
          >
            ...
            <div class="md:ml-auto">
              <div class="flex space-x-2">
                <!-- :class="['.', '.', ...]" 要給js array喔，每個元素是一個屬性值字串 -->
                <RouterLink
                  to="/"
